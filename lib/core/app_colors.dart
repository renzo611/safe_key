...
class AppColors {
  ...
  static const Color onSecondaryLight = Color(0xFF000000); // Black
  ...
  static const Color backgroundDark = Color(0xFF121212); // Rich Black
  static const Color surfaceDark = Color(0xFF1E1E1E); // Eerie Black
  static const Color errorDark = Color(0xFFEF5350); // Light Coral Red
